...
class PhoneBillProcessor extends Actor with ActorLogging {
  ...
  override def receive = {
    ...
    case (username:String,billstoPay:CaseBill) =>
      ...
      if(billstoPay.amount!=billstoPay.paidAmount) {
        ...
        dbRef ! (username, amountDeducted, billstoPay,updatedBill,"Phone")
      }
...
object PhoneBillProcessor {

  def prop:Props = Props[PhoneBillProcessor]
